...
{{- $resourceURIPrefix := trimAll "/" (required ".Values.deployment.skaha.sessions.userStorage.admin.resourceURIPrefix resourceURIPrefix is required." .Values.deployment.skaha.sessions.userStorage.admin.resourceURIPrefix) -}}
...
{{- printf "%s/%s" $resourceURIPrefix $homeDirectoryName -}}
{{- end -}}
